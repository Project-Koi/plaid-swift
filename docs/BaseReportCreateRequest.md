...
**daysRequested** | **Int** | The duration of transaction history you requested | 
**webhook** | **String** | URL to which Plaid will send Assets webhooks, for example when the requested Asset Report is ready. | 
**consumerReportPermissiblePurpose** | [**ConsumerReportPermissiblePurpose**](ConsumerReportPermissiblePurpose.md) |  | 
