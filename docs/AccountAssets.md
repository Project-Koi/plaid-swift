...
**balances** | [**AssetReportAccountBalance**](AssetReportAccountBalance.md) |  | 
...
**daysAvailable** | **Double** | The duration of transaction history available for this Item, typically defined as the time since the date of the earliest transaction in that account. | 
**transactions** | [AssetReportTransaction] | Transaction history associated with the account. | 
**investments** | [**AssetReportInvestments**](AssetReportInvestments.md) |  | [optional] 
...
**historicalBalances** | [HistoricalBalance] | Calculated data about the historical balances on the account. | 
