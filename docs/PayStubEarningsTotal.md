...
------------ | ------------- | ------------- | -------------
**currentAmount** | **Double** | Total amount of the earnings for this pay period. | 
**hours** | **Double** | Total number of hours worked for this pay period. | 
...
**ytdAmount** | **Double** | The total year-to-date amount of the earnings. | 
