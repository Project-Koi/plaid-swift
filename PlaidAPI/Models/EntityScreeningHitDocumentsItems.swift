//
// EntityScreeningHitDocumentsItems.swift
//
...
public struct EntityScreeningHitDocumentsItems: Codable, JSONEncodable, Hashable {

    public var analysis: MatchSummary?
    public var data: EntityDocument?

    public init(analysis: MatchSummary? = nil, data: EntityDocument? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        data = try container.decodeIfPresent(EntityDocument.self, forKey: .data)
