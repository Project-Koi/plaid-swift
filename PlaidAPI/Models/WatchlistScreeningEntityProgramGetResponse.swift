//
// WatchlistScreeningEntityProgramGetResponse.swift
//
...
public struct WatchlistScreeningEntityProgramGetResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, createdAt: Date, isRescanningEnabled: Bool, listsEnabled: Set<EntityWatchlistCode>, name: String, nameSensitivity: ProgramNameSensitivity, auditTrail: WatchlistScreeningAuditTrail, isArchived: Bool, requestId: String) {
        self.id = id
