//
// ScreeningHitDateOfBirthItem.swift
//
...
public struct ScreeningHitDateOfBirthItem: Codable, JSONEncodable, Hashable {

    public var analysis: MatchSummary?
    public var data: DateRange?

    public init(analysis: MatchSummary? = nil, data: DateRange? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        data = try container.decodeIfPresent(DateRange.self, forKey: .data)
