//
// WatchlistScreeningEntityReviewCreateRequest.swift
//
...
public struct WatchlistScreeningEntityReviewCreateRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(confirmedHits: [String], dismissedHits: [String], comment: String? = nil, clientId: String? = nil, secret: String? = nil, entityWatchlistScreeningId: String) {
