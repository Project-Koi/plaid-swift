...
public struct TransferIntentCreate: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, created: Date, status: TransferIntentStatus, accountId: String? = nil, originationAccountId: String, fundingAccountId: String, amount: String, mode: TransferIntentCreateMode, network: TransferIntentCreateNetwork? = nil, achClass: ACHClass? = nil, user: TransferUserInResponse, description: String, metadata: [String: String]? = nil, isoCurrencyCode: String, requireGuarantee: Bool? = nil) {
        self.id = id
