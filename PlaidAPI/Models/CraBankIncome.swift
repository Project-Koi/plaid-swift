...
public struct CraBankIncome: Codable, JSONEncodable, Hashable {
    ...
    public var items: [CraBankIncomeItem]?
    public var bankIncomeSummary: CraBankIncomeSummary?
    ...
    public var warnings: [CraBankIncomeWarning]?

    public init(bankIncomeId: String? = nil, generatedTime: Date? = nil, daysRequested: Int? = nil, items: [CraBankIncomeItem]? = nil, bankIncomeSummary: CraBankIncomeSummary? = nil, warnings: [CraBankIncomeWarning]? = nil) {
