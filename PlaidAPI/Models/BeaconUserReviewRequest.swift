...
public struct BeaconUserReviewRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(beaconUserId: String, status: BeaconUserStatus, clientId: String? = nil, secret: String? = nil) {
