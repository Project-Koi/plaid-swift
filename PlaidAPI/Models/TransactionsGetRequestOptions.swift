//
// TransactionsGetRequestOptions.swift
//
...
public struct TransactionsGetRequestOptions: Codable, JSONEncodable, Hashable {
    ...
    public init(accountIds: [String]? = nil, count: Int? = 100, offset: Int? = 0, includeOriginalDescription: Bool? = false, includePersonalFinanceCategoryBeta: Bool? = false, includePersonalFinanceCategory: Bool? = false, includeLogoAndCounterpartyBeta: Bool? = false, daysRequested: Int? = 90) {
