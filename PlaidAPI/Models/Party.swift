...
public struct Party: Codable, JSONEncodable, Hashable {
    ...
    public var INDIVIDUAL: PartyIndividual
    public var ROLES: Roles
    public var TAXPAYER_IDENTIFIERS: TaxpayerIdentifiers

    public init(INDIVIDUAL: PartyIndividual, ROLES: Roles, TAXPAYER_IDENTIFIERS: TaxpayerIdentifiers) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        INDIVIDUAL = try container.decode(PartyIndividual.self, forKey: .INDIVIDUAL)
