...
public struct Service: Codable, JSONEncodable, Hashable {
    ...
    public var VERIFICATION_OF_ASSET: VerificationOfAsset
    public var STATUSES: Statuses

    public init(VERIFICATION_OF_ASSET: VerificationOfAsset, STATUSES: Statuses) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        VERIFICATION_OF_ASSET = try container.decode(VerificationOfAsset.self, forKey: .VERIFICATION_OF_ASSET)
