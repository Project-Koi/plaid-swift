//
// TransferOriginatorGetRequest.swift
//
...
public struct TransferOriginatorGetRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(clientId: String? = nil, secret: String? = nil, originatorClientId: String) {
