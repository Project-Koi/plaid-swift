...
public struct BeaconUser: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, version: Int, createdAt: Date, updatedAt: Date, status: BeaconUserStatus, programId: String, clientUserId: String, user: BeaconUserData, auditTrail: BeaconAuditTrail) {
        self.id = id
