//
// WatchlistScreeningIndividualProgramGetResponse.swift
//
...
public struct WatchlistScreeningIndividualProgramGetResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, createdAt: Date, isRescanningEnabled: Bool, listsEnabled: Set<IndividualWatchlistCode>, name: String, nameSensitivity: ProgramNameSensitivity, auditTrail: WatchlistScreeningAuditTrail, isArchived: Bool, requestId: String) {
        self.id = id
