//
// BankTransferCreateRequest.swift
//
...
public struct BankTransferCreateRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(clientId: String? = nil, secret: String? = nil, idempotencyKey: String, accessToken: String, accountId: String, type: BankTransferType, network: BankTransferNetwork, amount: String, isoCurrencyCode: String, description: String, achClass: ACHClass? = nil, user: BankTransferUser, customTag: String? = nil, metadata: [String: String]? = nil, originationAccountId: String? = nil) {
