//
// ExternalPaymentScheduleRequest.swift
//
...
public struct ExternalPaymentScheduleRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(interval: PaymentScheduleInterval, intervalExecutionDay: Int, startDate: Date, endDate: Date? = nil, adjustedStartDate: Date? = nil) {
