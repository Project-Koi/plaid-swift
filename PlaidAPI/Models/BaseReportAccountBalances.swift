//
// BaseReportAccountBalances.swift
//
...
public struct BaseReportAccountBalances: Codable, JSONEncodable, Hashable {
    ...
    public var averageMonthlyBalances: [BaseReportAverageMonthlyBalances]?
    /** The average historical balance from the most recent 30 days */
    public var mostRecentThirtyDayAverageBalance: Double?

    public init(available: Double?, current: Double?, limit: Double?, isoCurrencyCode: String?, unofficialCurrencyCode: String?, lastUpdatedDatetime: Date? = nil, averageBalance: Double? = nil, averageMonthlyBalances: [BaseReportAverageMonthlyBalances]? = nil, mostRecentThirtyDayAverageBalance: Double? = nil) {
        ...
        self.averageMonthlyBalances = averageMonthlyBalances
        self.mostRecentThirtyDayAverageBalance = mostRecentThirtyDayAverageBalance
    }
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case averageMonthlyBalances = "average_monthly_balances"
        case mostRecentThirtyDayAverageBalance = "most_recent_thirty_day_average_balance"
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(averageMonthlyBalances, forKey: .averageMonthlyBalances)
        try container.encodeIfPresent(mostRecentThirtyDayAverageBalance, forKey: .mostRecentThirtyDayAverageBalance)
    ...
    public init(from decoder: Decoder) throws {
        ...
        averageBalance = try container.decodeIfPresent(Double.self, forKey: .averageBalance)
        averageMonthlyBalances = try container.decodeIfPresent([BaseReportAverageMonthlyBalances].self, forKey: .averageMonthlyBalances)
        mostRecentThirtyDayAverageBalance = try container.decodeIfPresent(Double.self, forKey: .mostRecentThirtyDayAverageBalance)
        ...
        nonAdditionalPropertyKeys.insert("average_monthly_balances")
        nonAdditionalPropertyKeys.insert("most_recent_thirty_day_average_balance")
