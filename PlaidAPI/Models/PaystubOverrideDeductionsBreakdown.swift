//
// PaystubOverrideDeductionsBreakdown.swift
//
...
public struct PaystubOverrideDeductionsBreakdown: Codable, JSONEncodable, Hashable {
    ...
    public init(currentAmount: Double? = nil, description: String? = nil, currency: String? = nil, ytdAmount: Double? = nil) {
