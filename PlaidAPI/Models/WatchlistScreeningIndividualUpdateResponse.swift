//
// WatchlistScreeningIndividualUpdateResponse.swift
//
...
public struct WatchlistScreeningIndividualUpdateResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, searchTerms: WatchlistScreeningSearchTerms, assignee: String?, status: WatchlistScreeningStatus, clientUserId: String?, auditTrail: WatchlistScreeningAuditTrail, requestId: String) {
        self.id = id
