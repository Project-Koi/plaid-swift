//
// SandboxTransferTestClockGetRequest.swift
//
...
public struct SandboxTransferTestClockGetRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(clientId: String? = nil, secret: String? = nil, testClockId: String) {
