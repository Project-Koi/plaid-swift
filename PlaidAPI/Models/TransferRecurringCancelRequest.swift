//
// TransferRecurringCancelRequest.swift
//
...
public struct TransferRecurringCancelRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(clientId: String? = nil, secret: String? = nil, recurringTransferId: String) {
