...
public struct DeductionsBreakdown: Codable, JSONEncodable, Hashable {
    ...
    public init(currentAmount: Double? = nil, description: String? = nil, isoCurrencyCode: String? = nil, unofficialCurrencyCode: String? = nil, ytdAmount: Double? = nil) {
