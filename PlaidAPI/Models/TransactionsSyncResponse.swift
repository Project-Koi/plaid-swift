//
// TransactionsSyncResponse.swift
//
...
public struct TransactionsSyncResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(transactionsUpdateStatus: TransactionsUpdateStatus, accounts: [AccountBase], added: [Transaction], modified: [Transaction], removed: [RemovedTransaction], nextCursor: String, hasMore: Bool, requestId: String) {
