//
// LinkOAuthCorrelationIdExchangeResponse.swift
//
...
public struct LinkOAuthCorrelationIdExchangeResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(linkToken: String, requestId: String) {
