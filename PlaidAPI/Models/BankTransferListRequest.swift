...
public struct BankTransferListRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(clientId: String? = nil, secret: String? = nil, startDate: Date? = nil, endDate: Date? = nil, count: Int? = 25, offset: Int? = 0, originationAccountId: String? = nil, direction: BankTransferDirection? = nil) {
