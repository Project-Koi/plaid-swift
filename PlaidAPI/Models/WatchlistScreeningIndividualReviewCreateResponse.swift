//
// WatchlistScreeningIndividualReviewCreateResponse.swift
//
...
public struct WatchlistScreeningIndividualReviewCreateResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, confirmedHits: [String], dismissedHits: [String], comment: String?, auditTrail: WatchlistScreeningAuditTrail, requestId: String) {
        self.id = id
