...
public struct IdentityGetResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(accounts: [AccountIdentity], item: Item, requestId: String) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        accounts = try container.decode([AccountIdentity].self, forKey: .accounts)
