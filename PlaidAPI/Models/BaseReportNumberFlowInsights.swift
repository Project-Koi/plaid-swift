//
// BaseReportNumberFlowInsights.swift
//
...
public struct BaseReportNumberFlowInsights: Codable, JSONEncodable, Hashable {
    ...
    public init(startDate: Date? = nil, endDate: Date? = nil, count: Int? = nil) {
