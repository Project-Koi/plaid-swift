//
// WatchlistScreeningEntityUpdateRequest.swift
//
...
public struct WatchlistScreeningEntityUpdateRequest: Codable, JSONEncodable, Hashable {
    ...
    public var searchTerms: UpdateEntityScreeningRequestSearchTerms?
    ...
    public var resetFields: [WatchlistScreeningEntityUpdateRequestResettableField]?

    public init(entityWatchlistScreeningId: String, searchTerms: UpdateEntityScreeningRequestSearchTerms? = nil, assignee: String? = nil, status: WatchlistScreeningStatus? = nil, clientUserId: String? = nil, clientId: String? = nil, secret: String? = nil, resetFields: [WatchlistScreeningEntityUpdateRequestResettableField]? = nil) {
