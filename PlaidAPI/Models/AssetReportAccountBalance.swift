//
// AssetReportAccountBalance.swift
//
...
public struct AssetReportAccountBalance: Codable, JSONEncodable, Hashable {
    ...
    public var marginLoanAmount: Double?
    ...
    public init(available: Double?, current: Double?, limit: Double?, marginLoanAmount: Double?, isoCurrencyCode: String?, unofficialCurrencyCode: String?, lastUpdatedDatetime: Date? = nil) {
        self.available = available
        self.current = current
        self.limit = limit
        self.marginLoanAmount = marginLoanAmount
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case current
        case limit
        case marginLoanAmount = "margin_loan_amount"
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(marginLoanAmount, forKey: .marginLoanAmount)
    ...
    public init(from decoder: Decoder) throws {
        ...
        marginLoanAmount = try container.decodeIfPresent(Double.self, forKey: .marginLoanAmount)
        ...
        nonAdditionalPropertyKeys.insert("margin_loan_amount")
