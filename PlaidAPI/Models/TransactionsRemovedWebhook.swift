//
// TransactionsRemovedWebhook.swift
//
...
public struct TransactionsRemovedWebhook: Codable, JSONEncodable, Hashable {
    ...
    public init(webhookType: String, webhookCode: String, error: PlaidError? = nil, removedTransactions: [String], itemId: String, environment: WebhookEnvironmentValues) {
