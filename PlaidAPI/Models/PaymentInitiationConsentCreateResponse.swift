//
// PaymentInitiationConsentCreateResponse.swift
//
...
public struct PaymentInitiationConsentCreateResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(consentId: String, status: PaymentInitiationConsentStatus, requestId: String) {
