//
// ProcessorSignalEvaluateResponse.swift
//
...
public struct ProcessorSignalEvaluateResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(requestId: String, scores: SignalScores, coreAttributes: SignalEvaluateCoreAttributes? = nil, warnings: [SignalWarning]? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        warnings = try container.decodeIfPresent([SignalWarning].self, forKey: .warnings)
