...
public struct PayStubDeductionsTotal: Codable, JSONEncodable, Hashable {
    ...
    public init(currentAmount: Double?, isoCurrencyCode: String?, unofficialCurrencyCode: String?, ytdAmount: Double?) {
