//
// PaystubOverridePayPeriodDetails.swift
//
...
public struct PaystubOverridePayPeriodDetails: Codable, JSONEncodable, Hashable {

    /** The amount of the paycheck. */
    public var checkAmount: Double?
    public var distributionBreakdown: [PaystubOverrideDistributionBreakdown]?
    ...
    public init(checkAmount: Double? = nil, distributionBreakdown: [PaystubOverrideDistributionBreakdown]? = nil, endDate: Date? = nil, grossEarnings: Double? = nil, payDate: Date? = nil, payFrequency: PayPeriodDetailsPayFrequency? = nil, payDay: Date? = nil, startDate: Date? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        distributionBreakdown = try container.decodeIfPresent([PaystubOverrideDistributionBreakdown].self, forKey: .distributionBreakdown)
