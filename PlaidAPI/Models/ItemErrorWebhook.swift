...
public struct ItemErrorWebhook: Codable, JSONEncodable, Hashable {
    ...
    public init(webhookType: String, webhookCode: String, itemId: String, error: PlaidError?, environment: WebhookEnvironmentValues) {
