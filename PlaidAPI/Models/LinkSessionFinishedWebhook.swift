...
public struct LinkSessionFinishedWebhook: Codable, JSONEncodable, Hashable {
    ...
    public init(webhookType: String, webhookCode: String, status: String, linkSessionId: String, linkToken: String, publicToken: String? = nil, environment: WebhookEnvironmentValues) {
