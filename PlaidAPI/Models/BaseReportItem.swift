...
public struct BaseReportItem: Codable, JSONEncodable, Hashable {
    ...
    public var accounts: [BaseReportAccount]

    public init(institutionName: String, institutionId: String, dateLastUpdated: Date, accounts: [BaseReportAccount]) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        accounts = try container.decode([BaseReportAccount].self, forKey: .accounts)
