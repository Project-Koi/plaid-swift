...
public struct BeaconAuditTrail: Codable, JSONEncodable, Hashable {

    public var source: BeaconAuditTrailSource
    /** ID of the associated user. */
    public var dashboardUserId: String?
    /** An ISO8601 formatted timestamp. */
    public var timestamp: Date

    public init(source: BeaconAuditTrailSource, dashboardUserId: String?, timestamp: Date) {
        self.source = source
    ...
    public init(from decoder: Decoder) throws {
        ...
        source = try container.decode(BeaconAuditTrailSource.self, forKey: .source)
