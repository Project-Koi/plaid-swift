...
public struct LiabilitiesGetResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(accounts: [AccountBase], item: Item, liabilities: LiabilitiesObject, requestId: String) {
