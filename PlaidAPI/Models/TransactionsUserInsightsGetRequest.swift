//
// TransactionsUserInsightsGetRequest.swift
//
...
public struct TransactionsUserInsightsGetRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(clientId: String? = nil, secret: String? = nil, clientUserId: String) {
