...
public struct Counterparty: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String, entityId: String? = nil, type: CounterpartyType, website: String?, logoUrl: String?, confidenceLevel: String? = nil, phoneNumber: String?) {
        self.name = name
