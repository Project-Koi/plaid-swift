//
// UserPermissionRevokedWebhook.swift
//
...
public struct UserPermissionRevokedWebhook: Codable, JSONEncodable, Hashable {
    ...
    public init(webhookType: String, webhookCode: String, itemId: String, error: PlaidError? = nil, environment: WebhookEnvironmentValues) {
