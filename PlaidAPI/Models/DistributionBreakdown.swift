...
public struct DistributionBreakdown: Codable, JSONEncodable, Hashable {
    ...
    public init(accountName: String? = nil, bankName: String? = nil, currentAmount: Double? = nil, isoCurrencyCode: String? = nil, mask: String? = nil, type: String? = nil, unofficialCurrencyCode: String? = nil, currentPay: Pay? = nil) {
