...
public struct NumbersACH: Codable, JSONEncodable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        wireRouting = try container.decodeIfPresent(String.self, forKey: .wireRouting)
        canTransferIn = try container.decodeIfPresent(Bool.self, forKey: .canTransferIn)
        canTransferOut = try container.decodeIfPresent(Bool.self, forKey: .canTransferOut)
        var nonAdditionalPropertyKeys = Set<String>()
        nonAdditionalPropertyKeys.insert("account_id")
        nonAdditionalPropertyKeys.insert("account")
        nonAdditionalPropertyKeys.insert("routing")
        nonAdditionalPropertyKeys.insert("wire_routing")
        nonAdditionalPropertyKeys.insert("can_transfer_in")
        nonAdditionalPropertyKeys.insert("can_transfer_out")
