...
public struct AssetReportInvestments: Codable, JSONEncodable, Hashable {
    ...
    public init(investmentTransactionId: String, accountId: String, securityId: String?, date: Date, name: String, quantity: Double, vestedQuantity: Double, vestedValue: Double, amount: Double, price: Double, fees: Double?, type: InvestmentTransactionType, subtype: InvestmentTransactionSubtype, isoCurrencyCode: String?, unofficialCurrencyCode: String?) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(vestedQuantity, forKey: .vestedQuantity)
        try container.encode(vestedValue, forKey: .vestedValue)
    ...
    public init(from decoder: Decoder) throws {
        ...
        vestedQuantity = try container.decode(Double.self, forKey: .vestedQuantity)
        vestedValue = try container.decode(Double.self, forKey: .vestedValue)
