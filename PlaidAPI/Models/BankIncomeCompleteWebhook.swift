//
// BankIncomeCompleteWebhook.swift
//
...
public struct BankIncomeCompleteWebhook: Codable, JSONEncodable, Hashable {
    ...
    public var result: BankIncomeCompleteResult
    public var environment: WebhookEnvironmentValues

    public init(webhookType: String, webhookCode: String, userId: String, result: BankIncomeCompleteResult, environment: WebhookEnvironmentValues) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        result = try container.decode(BankIncomeCompleteResult.self, forKey: .result)
