//
// BeaconReportCreateResponse.swift
//
...
public struct BeaconReportCreateResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, beaconUserId: String, createdAt: Date, type: BeaconReportType, fraudDate: Date, fraudAmount: FraudAmount?, auditTrail: BeaconAuditTrail, requestId: String) {
        self.id = id
