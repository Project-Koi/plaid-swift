//
// BeaconUserRequestAddressNullable.swift
//
...
public struct BeaconUserRequestAddressNullable: Codable, JSONEncodable, Hashable {
    ...
    public init(street: String, street2: String? = nil, city: String, region: String? = nil, postalCode: String? = nil, country: String) {
        self.street = street
