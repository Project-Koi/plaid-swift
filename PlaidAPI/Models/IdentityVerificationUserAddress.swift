//
// IdentityVerificationUserAddress.swift
//
...
public struct IdentityVerificationUserAddress: Codable, JSONEncodable, Hashable {
    ...
    public init(street: String?, street2: String?, city: String?, region: String?, postalCode: String?, country: String) {
        self.street = street
