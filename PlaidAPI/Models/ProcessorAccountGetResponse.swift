//
// ProcessorAccountGetResponse.swift
//
...
public struct ProcessorAccountGetResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(account: AccountBase, institutionId: String, requestId: String) {
