...
public struct AccountIdentity: Codable, JSONEncodable, Hashable {
    ...
    public var documents: [IdentityDocument]?

    public init(accountId: String, balances: AccountBalance, mask: String?, name: String, officialName: String?, type: AccountType, subtype: AccountSubtype?, verificationStatus: VerificationStatus? = nil, verificationInsights: AccountVerificationInsights? = nil, persistentAccountId: String? = nil, owners: [Owner], documents: [IdentityDocument]? = nil) {
