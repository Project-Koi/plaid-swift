//
// TransferLedgerWithdrawRequest.swift
//
...
public struct TransferLedgerWithdrawRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(clientId: String? = nil, secret: String? = nil, originatorClientId: String? = nil, fundingAccountId: String? = nil, amount: String, description: String? = nil, idempotencyKey: String, network: TransferNetwork) {
