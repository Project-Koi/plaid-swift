//
// SyncUpdatesAvailableWebhook.swift
//
...
public struct SyncUpdatesAvailableWebhook: Codable, JSONEncodable, Hashable {
    ...
    public init(webhookType: String, webhookCode: String, itemId: String, initialUpdateComplete: Bool, historicalUpdateComplete: Bool, environment: WebhookEnvironmentValues) {
