...
public struct AssetReportGetResponse: Codable, JSONEncodable, Hashable {

    public var report: AssetReport
    ...
    public init(report: AssetReport, warnings: [Warning], requestId: String) {
        self.report = report
    ...
    public init(from decoder: Decoder) throws {
        ...
        report = try container.decode(AssetReport.self, forKey: .report)
