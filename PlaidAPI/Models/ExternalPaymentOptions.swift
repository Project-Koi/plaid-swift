...
public struct ExternalPaymentOptions: Codable, JSONEncodable, Hashable {
    ...
    public init(requestRefundDetails: Bool? = nil, iban: String? = nil, bacs: PaymentInitiationOptionalRestrictionBacs? = nil, scheme: PaymentScheme? = nil) {
