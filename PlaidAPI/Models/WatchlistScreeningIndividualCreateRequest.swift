//
// WatchlistScreeningIndividualCreateRequest.swift
//
...
public struct WatchlistScreeningIndividualCreateRequest: Codable, JSONEncodable, Hashable {

    static let clientUserIdRule = StringRule(minLength: 1, maxLength: nil, pattern: nil)
    public var searchTerms: WatchlistScreeningRequestSearchTerms
    ...
    public init(searchTerms: WatchlistScreeningRequestSearchTerms, clientUserId: String? = nil, clientId: String? = nil, secret: String? = nil) {
