...
public struct EarningsBreakdown: Codable, JSONEncodable, Hashable {
    ...
    public init(canonicalDescription: EarningsBreakdownCanonicalDescription? = nil, currentAmount: Double? = nil, description: String? = nil, hours: Double? = nil, isoCurrencyCode: String? = nil, rate: Double? = nil, unofficialCurrencyCode: String? = nil, ytdAmount: Double? = nil) {
