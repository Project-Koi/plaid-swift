//
// BankTransferCancelRequest.swift
//
...
public struct BankTransferCancelRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(clientId: String? = nil, secret: String? = nil, bankTransferId: String) {
