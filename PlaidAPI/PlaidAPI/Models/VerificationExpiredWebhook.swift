//
// VerificationExpiredWebhook.swift
//
...
public struct VerificationExpiredWebhook: Codable, JSONEncodable, Hashable {
    ...
    public init(webhookType: String, webhookCode: String, itemId: String, accountId: String, environment: WebhookEnvironmentValues, error: PlaidError? = nil) {
