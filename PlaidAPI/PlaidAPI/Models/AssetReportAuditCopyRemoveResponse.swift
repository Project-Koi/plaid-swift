//
// AssetReportAuditCopyRemoveResponse.swift
//
...
public struct AssetReportAuditCopyRemoveResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(removed: Bool, requestId: String) {
