//
// ProcessorSignalDecisionReportRequest.swift
//
...
public struct ProcessorSignalDecisionReportRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(clientId: String? = nil, secret: String? = nil, processorToken: String, clientTransactionId: String, initiated: Bool, daysFundsOnHold: Int? = nil, decisionOutcome: SignalDecisionOutcome? = nil, paymentMethod: SignalPaymentMethod? = nil, amountInstantlyAvailable: Double? = nil) {
