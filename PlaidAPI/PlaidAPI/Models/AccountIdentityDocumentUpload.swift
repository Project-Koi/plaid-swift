//
// AccountIdentityDocumentUpload.swift
//
...
public struct AccountIdentityDocumentUpload: Codable, JSONEncodable, Hashable {
    ...
    public var documents: [IdentityDocumentUpload]?

    public init(accountId: String, balances: AccountBalance, mask: String?, name: String, officialName: String?, type: AccountType, subtype: AccountSubtype?, verificationStatus: VerificationStatus? = nil, verificationInsights: AccountVerificationInsights? = nil, persistentAccountId: String? = nil, owners: [Owner], documents: [IdentityDocumentUpload]? = nil) {
