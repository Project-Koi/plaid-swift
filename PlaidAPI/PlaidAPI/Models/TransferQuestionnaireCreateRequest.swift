//
// TransferQuestionnaireCreateRequest.swift
//
...
public struct TransferQuestionnaireCreateRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(clientId: String? = nil, secret: String? = nil, originatorClientId: String, redirectUri: String) {
