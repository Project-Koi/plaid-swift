...
public struct Cause: Codable, JSONEncodable, Hashable {
    ...
    public init(errorType: PlaidErrorType, errorCode: String, errorMessage: String, displayMessage: String?, requestId: String? = nil, causes: [AnyCodable]? = nil, status: Int? = nil, documentationUrl: String? = nil, suggestedAction: String? = nil, itemId: String) {
