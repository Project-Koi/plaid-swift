...
public struct WatchlistScreeningHit: Codable, JSONEncodable, Hashable {
    ...
    public var listCode: IndividualWatchlistCode
    ...
    public var analysis: ScreeningHitAnalysis?
    public var data: ScreeningHitData?

    public init(id: String, reviewStatus: WatchlistScreeningHitStatus, firstActive: Date, inactiveSince: Date?, historicalSince: Date?, listCode: IndividualWatchlistCode, plaidUid: String, sourceUid: String?, analysis: ScreeningHitAnalysis? = nil, data: ScreeningHitData? = nil) {
        self.id = id
    ...
    public init(from decoder: Decoder) throws {
        ...
        listCode = try container.decode(IndividualWatchlistCode.self, forKey: .listCode)
        ...
        analysis = try container.decodeIfPresent(ScreeningHitAnalysis.self, forKey: .analysis)
        data = try container.decodeIfPresent(ScreeningHitData.self, forKey: .data)
