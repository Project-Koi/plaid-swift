//
// TransferRepaymentReturnListRequest.swift
//
...
public struct TransferRepaymentReturnListRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(clientId: String? = nil, secret: String? = nil, repaymentId: String, count: Int? = 25, offset: Int? = 0) {
