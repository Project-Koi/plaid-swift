//
// LinkSessionFinishedWebhook.swift
//
...
public struct LinkSessionFinishedWebhook: Codable, JSONEncodable, Hashable {
    ...
    public var publicTokens: [String]?
    public var environment: WebhookEnvironmentValues

    public init(webhookType: String, webhookCode: String, status: String, linkSessionId: String, linkToken: String, publicToken: String? = nil, publicTokens: [String]? = nil, environment: WebhookEnvironmentValues) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(publicTokens, forKey: .publicTokens)
    ...
    public init(from decoder: Decoder) throws {
        ...
        publicToken = try container.decodeIfPresent(String.self, forKey: .publicToken)
        publicTokens = try container.decodeIfPresent([String].self, forKey: .publicTokens)
        ...
        nonAdditionalPropertyKeys.insert("public_tokens")
