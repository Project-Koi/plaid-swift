...
public struct InitialUpdateWebhook: Codable, JSONEncodable, Hashable {
    ...
    public init(webhookType: String, webhookCode: String, error: String? = nil, newTransactions: Double, itemId: String, environment: WebhookEnvironmentValues) {
