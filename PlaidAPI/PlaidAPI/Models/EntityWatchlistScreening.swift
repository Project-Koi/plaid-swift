//
// EntityWatchlistScreening.swift
//
...
public struct EntityWatchlistScreening: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, searchTerms: EntityWatchlistScreeningSearchTerms, assignee: String?, status: WatchlistScreeningStatus, clientUserId: String?, auditTrail: WatchlistScreeningAuditTrail) {
        self.id = id
